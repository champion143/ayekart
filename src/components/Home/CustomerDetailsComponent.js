                ...
                <div className="PageContentContentDiv">
                  ...
                  <div className="HomeMainDiv">
                    <div className="HomeTopDiv">
                      <Row>
                        ...
                        <Col sm xs>
                          <div style={{ marginLeft: "10px" }}>
                            ...
                            <Link
                              to={`/profile/customer/${this.state.data.ID}`}
                              id="NoHoverLink"
                            >
                              <p>
                        ...
                        <Col sm xs>
                          <span style={{ float: "right" }}>
                            <img src={CallIcon} style={{ width: "20px" }} />
                          </span>
                        </Col>
                      </Row>
                      <Row>
                      ...
                      <Row>
                        <Col sm xs="6" className="nopadding">
                          <div
                            className="HomeThirdDivPayItems"
                            onClick={() => this.handleCollectNowDialogOpen()}
                          >
                            <h6>
                              <img
                                src={CollectnowIcon}
                        ...
                        <Col sm xs="6" className="nopadding">
                          <Link
                            to={`/customer/report/${this.state.data.ID}`}
                            id="NoHoverLink"
                          >
                        ...
                        <Col sm xs="6" className="nopadding">
                          <div
                            className="HomeThirdDivPayItems"
                            onClick={() => this.handlePayNowDialogOpen()}
                          >
                            <h6>
                              <img src={PaynowIcon} style={{ width: "20px" }} />
                              <span
                                style={{
                                  marginLeft: "5px",
                                  paddingTop: "0px",
                        ...
                        <Col sm xs="6" className="nopadding">
                          <div className="HomeThirdDivPayItems">
                            <h6>
                              <img src={RemindIcon} style={{ width: "20px" }} />
                              <a
                                id="NoHoverLink"
                                target="_blank"
                                href={
