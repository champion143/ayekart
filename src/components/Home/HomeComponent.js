...
class HomeComponent extends Component {
        ...
        fetch(
            ...
            .then((result) => {
                ...
                if (result.data.customers.length !== 0) {
                    this.setState({
                        data: result.data,
                        customers: mostRecent === true ?
                            result.data.customers.reverse() : result.data.customers,
                        isLoading: false,
                    });
                } else {
                    this.setState({
    ...
    collectMoneySMS = () => {
        ...
        var data = {
            ...
            "notes": {
                "merchant_id": "1828",
                "merchant_name": this.state.selectedUser.first_name + " " + this.state.selectedUser.last_name,
            ...
            "reference_id": "aye" + this.state.selectedUser.mobile + Math.floor(Math.random() * 90000) + 1,
        ...
        fetch("http://139.59.91.183/ayekart/api/hisab/razor_pay/response/", requestOptions)
            .then(response => response.json())
            .then(result => {
    ...
    render() {
        ...
        return ( <
                ...
                <
                Dialog maxWidth = "lg"
                open = { this.state.finoUnAuthorizedDialogOpen } >
                <
        ...
        DialogContent >
            ...
            To Pay: ₹{ " " } {
                this.state.selectedUser.to_pay - this.state.selectedUser.paid < 0 ?
                    ...
                    this.state.selectedUser.to_pay - this.state.selectedUser.paid
            } <
            /h6> <
        div style = {
                { marginTop: "20px" }
        ...
        div > <
            /DialogContent> < /
        Dialog > <
            Dialog open = { this.state.mobileDialogOpen }
        onClose = { this.handleMobileDialogClose } >
            ...
            h5 >
            <
            LangConvertComponent name = "customer_name" / >: { " " } { this.state.selectedMobileNumber.name } <
            /h5> <
        h6 >
            <
            LangConvertComponent name = "mobile_number" / >: { " " } { this.state.selectedMobileNumber.mobile } <
            /h6> < /
        div > <
            /DialogContent> < /
        Dialog >
            ...
            <
            Dialog open = { this.state.addCustomerDialogOpen }
        ...
        br / >
            ...
            <
            input className = "HomeBlueButtonInput"
        id = ""
        type = "submit"
        value = "Add" /
            >
        ...
        onClick = {
                () => {
                    ...
                    this.getHomeDetails(
                        this.state.cookies.get("userInfo"), !this.state.mostRecent
                    );
                }
            } >
            <
        ...
        onClick = {
                () => this.handleAddCustomerDialogOpen()
            } >
            <
            img src = { AddIcon }
        style = {
            ...
            Row > {
                this.state.customers.length === 0 ? ( <
                    ...
                    this.state.customers.map((item) => ( <
                        ...
                        Col sm xs className = "nopadding" >
                        <
                        Link to = { `/addhisabentry/${item.ID}/${item.first_name + " " + item.last_name}/${item.mobile}` }
                        id = "NoHoverLink" >
                        <
                        div className = "HomeThirdDivPayItems" >
                        <
